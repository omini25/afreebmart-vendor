...
export const Coupons = () => {
    ...
    useEffect(() => {
        const fetchCoupons = async () => {
            try {
                const response = await axios.get(`${server}/vendor/coupons/${user.user.id}`);
                                                        ...
                                                        filteredCoupons.map((coupon) => (
                                                            <tr key={coupon.id}>
                                                                <td className="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                                                                    <div className="flex items-center">
                                                                        <div className="ml-4">
                                                                            ...
                                                                            <div className="mt-1 text-gray-500">#{coupon.code}</div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                                                                    <div className="text-gray-900">$ {coupon.discount_type}</div>
                                                                    <div className="mt-1 text-gray-500">{coupon.discount}</div>
                                                                </td>
                                                                <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                                                                    <div className="text-gray-900">{coupon.start_date}</div>
                                                                    <div className="mt-1 text-gray-500">{coupon.end_date}</div>
                                                                </td>
                                                                <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                                                                ...
                                                                <td className="relative whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                                                    <Link to={`/coupon/${coupon.id}`} className="text-indigo-600 hover:text-indigo-900">
